...
web = [
    path("", views.home),
    path("subscribe/<organization_slug>/<concept_slug>/", views.subscribe, name='view-concept'),
    path("subscribe/<organization_slug>/<concept_slug>/apply/", views.subscribe, name='apply-to-concept')
]
