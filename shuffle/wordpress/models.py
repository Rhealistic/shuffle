...
class Post(models.Model):
    ...
    media_alt_text = models.CharField(max_length=100, null=True)
    media_caption = models.CharField(max_length=100, null=True)
    media_description = models.CharField(max_length=100, null=True)
